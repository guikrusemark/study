...
def test_get_all_users(client: FlaskClient) -> None:
    ...
    data1: Dict[str, str] = {"username": "user1", "email": "user1@example.com"}
    data2: Dict[str, str] = {"username": "user2", "email": "user2@example.com"}
...
def test_update_user(client: FlaskClient) -> None:
    ...
    update_data: Dict[str, str] = {"username": "updateduser"}
