...
def test_api() -> None:
    ...
    for person_data in persons_data:
        ...
        print(f"Created person: {response.json()['first_name']} {response.json()['last_name']}")
    ...
    for person in persons:
        print(f"  - {person['first_name']} {person['last_name']} (Age: {person.get('age', 'N/A')})")
    ...
    if person_ids:
        ...
        response = requests.put(f"{BASE_URL}/api/persons/{person_ids[0]}", json=update_data_person)
