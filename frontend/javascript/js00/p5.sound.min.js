...
!((t, e) => {
	...
	e = (() => {
		...
		t.prototype.isSupported = () => !!e.canPlayType;
		var i = () =>
				!!e.canPlayType && e.canPlayType('audio/ogg; codecs="vorbis"'),
			n = () => !!e.canPlayType && e.canPlayType("audio/mpeg;"),
			o = () => !!e.canPlayType && e.canPlayType('audio/wav; codecs="1"'),
			r = () =>
				!!e.canPlayType &&
				(e.canPlayType("audio/x-m4a;") || e.canPlayType("audio/aac;")),
			s = () => !!e.canPlayType && e.canPlayType("audio/x-aiff;");
		t.prototype.isFileSupported = (t) => {
	...
	n = ((e) => {
		...
		return (
			(t.prototype.getAudioContext = () => i),
			(t.prototype.userStartAudio = (n, o) => {
				var r = n;
				return (
	...
	o = (() => {
		var e = function () {
			...
			i = new e();
		return (
			(t.prototype.getMasterVolume = () => i.output.gain.value),
			(t.prototype.masterVolume = (t, e, n) => {
				if ("number" == typeof t) {
					var e = e || 0,
						n = n || 0,
	...
	r = (() => {
		...
		var r = o;
		(t.prototype.sampleRate = () => r.audiocontext.sampleRate),
			(t.prototype.freqToMidi = (t) => {
				var e = Math.log(t / 440) / Math.log(2),
					i = Math.round(12 * e) + 69;
				return i;
			});
		var s = (t.prototype.midiToFreq = (t) => 440 * Math.pow(2, (t - 69) / 12)),
			a = (t) => {
		...
		return (
			...
			(t.prototype._mathChain = (t, e, i, n, o) => {
	...
	s = (() => {
		var t = (t, e, i) => {
			...
			var o = n.split("\n");
			return (
				(o = o.filter((t) => !t.match(/(p5.|native code|globalInit)/g))),
				(r.stack = o.join("\n")),
				r
			);
		};
	...
	a = (() => {
		...
		"undefined" != typeof i.createStereoPanner
			? ((t.Panner = function (t, e) {
				...
				(t.Panner.prototype.inputChannels = () => {}),
	...
	u = (() => {
			...
			for (var e = [], i = Object.keys(t).sort(), n = 0; n < i.length; n++)
				for (var o = 0; 10 > o; o++) {
					...
					if (r && s) {
						...
						var p = e.some((t) => (t.interval === c ? (t.count++, t) : void 0));
			...
			return (
				t.forEach((t) => {
					try {
						...
						n = u(n);
						var o = i.some((e) =>
							e.tempo === n ? (e.count += t.count) : void 0,
						);
						if (!o) {
							if (isNaN(n)) return;
		...
		(t.SoundFile = function (e, i, n, o) {
			...
			(t.SoundFile.prototype.load = function (t, e) {
				...
				if (void 0 !== this.url && "" !== this.url) {
					...
					o.addEventListener(
							...
							if (200 === o.status) {
								...
								h.decodeAudioData(
									...
									(e) => {
										this.panner &&
											((this.buffer = e),
											this.panner.inputChannels(e.numberOfChannels),
											t && t(this));
									},
									() => {
										if (this.panner) {
											var t = new c("decodeAudioData", n, this.url),
												o =
								...
								if (!this.panner) return;
								var r = new c("loadSound", n, this.url),
									s =
										"Unable to load " +
										this.url +
						...
						(o.onerror = () => {
							var t = new c("loadSound", n, this.url),
								o =
				...
				if (
					...
					var h = function () {
						(this._playing = !1),
							...
							a._onended(a),
							a.bufferSourceNodes.forEach((t, e) => {
				...
				if (this.buffer && this.bufferSourceNode) {
					for (var n = 0; n < this.bufferSourceNodes.length; n++)
						if (void 0 !== typeof this.bufferSourceNodes[n])
							try {
								(this.bufferSourceNodes[n].onended = () => {}),
			...
			(t.SoundFile.prototype.getLevel = () => {
				console.warn(
		...
		(t.SoundFile.prototype._initCounterNode = function () {
			...
			return (
				this._scopeNode &&
					(this._scopeNode.disconnect(),
					delete this._scopeNode.onaudioprocess,
					delete this._scopeNode),
				(this._scopeNode = h.createScriptProcessor(256, 1, 1)),
				(n.buffer = d(this.buffer)),
				n.playbackRate.setValueAtTime(this.playbackRate, i),
				n.connect(this._scopeNode),
				this._scopeNode.connect(t.soundOut._silentNode),
				(this._scopeNode.onaudioprocess = (t) => {
					var i = t.inputBuffer.getChannelData(0);
					(this._lastPos = i[i.length - 1] || 0),
				...
				(g.type = "lowpass"),
					...
					(y.oncomplete = function (o) {
						if (self.panner) {
							...
							var u = i(h),
								c = n(u, r.sampleRate),
								p = c.sort((t, e) => e.count - t.count).splice(0, 5);
	...
	c = (() => {
		...
		(t.Amplitude = function (t) {
			...
			(t.Amplitude.prototype._audioProcess = function (t) {
				...
				var h = this.stereoVol.reduce(
					(t, e, i) => (
						(this.stereoVolNorm[i - 1] = Math.max(
							Math.min(this.stereoVol[i - 1] / this.volMax, 1),
							0,
						)),
						(this.stereoVolNorm[i] = Math.max(
							Math.min(this.stereoVol[i] / this.volMax, 1),
							0,
						)),
						t + e
					),
	...
	p = (() => {
		...
		(t.FFT = function (t, i) {
			...
			(t.FFT.prototype.getOctaveBands = (t, i) => {
				var t = t || 3,
					i = i || 15.625,
					n = [],
					o = {
	...
	h = (() => {
		...
		(t.prototype.set = function (e, i, n) {
			...
			(t.prototype.isUndef = (t) => "undefined" == typeof t),
			(t.prototype.isFunction = (t) => "function" == typeof t),
			(t.prototype.isNumber = (t) => "number" == typeof t),
			(t.prototype.isObject = (t) =>
				"[object Object]" === Object.prototype.toString.call(t) &&
				t.constructor === Object),
			(t.prototype.isBoolean = (t) => "boolean" == typeof t),
			(t.prototype.isArray = (t) => Array.isArray(t)),
			(t.prototype.isString = (t) => "string" == typeof t),
			(t.noOp = () => {}),
			...
			(t.prototype.equalPowerScale = (t) => {
				var e = 0.5 * Math.PI;
				return Math.sin(t * e);
			}),
			(t.prototype.dbToGain = (t) => Math.pow(2, t / 6)),
			(t.prototype.gainToDb = (t) => 20 * (Math.log(t) / Math.LN10)),
			(t.prototype.intervalToFrequencyRatio = (t) => Math.pow(2, t / 12)),
			(t.prototype.now = () => t.context.now()),
			(t.now = () => t.context.now()),
			(t.extend = (e, i) => {
				function n() {}
		...
		return (
			...
			Object.defineProperty(t.prototype, "context", { get: () => t.context }),
			(t.setContext = (e) => {
				t.context = e;
			}),
	...
	d = ((t) => (
		...
		(t.TimeBase.prototype._primaryExpressions = {
			...
			t: {
				...
				method: function (t) {
					return (
						(t = Number.parseInt(t)),
						this._beatsToUnits(8 / (3 * Number.parseInt(t)))
					);
				},
			},
			m: {
				regexp: /^(\d+)m/i,
				method: function (t) {
					return this._beatsToUnits(Number.parseInt(t) * this._timeSignature());
				},
			},
			i: {
				regexp: /^(\d+)i/i,
				method: function (t) {
					return this._ticksToUnits(Number.parseInt(t));
				},
			},
			hz: {
				regexp: /^(\d+(?:\.\d+)?)hz/i,
				method: function (t) {
					return this._frequencyToUnits(Number.parseFloat(t));
				},
			},
			tr: {
				regexp: /^(\d+(?:\.\d+)?):(\d+(?:\.\d+)?):?(\d+(?:\.\d+)?)?/,
					...
					return (
						t &&
							...
							(n += this._beatsToUnits(
								this._timeSignature() * Number.parseFloat(t),
							)),
						e && "0" !== e && (n += this._beatsToUnits(Number.parseFloat(e))),
						i &&
							"0" !== i &&
							(n += this._beatsToUnits(Number.parseFloat(i) / 4)),
						n
					);
				},
			},
			s: {
				regexp: /^(\d+(?:\.\d+)?s)/,
				method: function (t) {
					return this._secondsToUnits(Number.parseFloat(t));
				},
			},
			samples: {
				regexp: /^(\d+)samples/,
				method: function (t) {
					return Number.parseInt(t) / this.context.sampleRate;
				},
			},
			default: {
				regexp: /^(\d+(?:\.\d+)?)/,
		...
		(t.TimeBase.prototype._binaryExpressions = {
			"+": { regexp: /^\+/, precedence: 2, method: (t, e) => t() + e() },
			"-": { regexp: /^\-/, precedence: 2, method: (t, e) => t() - e() },
			"*": { regexp: /^\*/, precedence: 1, method: (t, e) => t() * e() },
			"/": { regexp: /^\//, precedence: 1, method: (t, e) => t() / e() },
		}),
		(t.TimeBase.prototype._unaryExpressions = {
			neg: { regexp: /^\-/, method: (t) => -t() },
		}),
		...
		(t.TimeBase.prototype._noOp = () => 0),
		(t.TimeBase.prototype._defaultExpr = function () {
			return this._noOp;
		}),
		(t.TimeBase.prototype._defaultUnits = "s"),
		(t.TimeBase.prototype._frequencyToUnits = (t) => 1 / t),
		(t.TimeBase.prototype._beatsToUnits = (e) =>
			(60 / t.Transport.bpm.value) * e),
		(t.TimeBase.prototype._secondsToUnits = (t) => t),
		(t.TimeBase.prototype._ticksToUnits = function (e) {
			return e * (this._beatsToUnits(1) / t.Transport.PPQ);
		}),
		(t.TimeBase.prototype._timeSignature = () => t.Transport.timeSignature),
	...
	m = ((t) => (
		...
		(t.Time.prototype._unaryExpressions.quantize = {
			regexp: /^@/,
			method: (e) => t.Transport.nextSubdivision(e()),
		}),
		...
		(t.Time.prototype.toBarsBeatsSixteenths = function () {
			...
			(e = Math.floor(e) % this._timeSignature()),
				(n = n.toString()),
				n.length > 3 && (n = Number.parseFloat(n).toFixed(3));
			var o = [i, e, n];
			return o.join(":");
		}),
	...
	y = ((t) => {
		(t.Frequency = function (e, i) {
			...
			(t.Frequency.prototype._frequencyToUnits = (t) => t),
			(t.Frequency.prototype._ticksToUnits = (e) =>
			...
			(t.Frequency.prototype._secondsToUnits = (t) => 1 / t),
		...
		return (
			(t.Frequency.A4 = 440),
			(t.Frequency.prototype.midiToFrequency = (e) =>
				t.Frequency.A4 * Math.pow(2, (e - 69) / 12)),
			(t.Frequency.prototype.frequencyToMidi = (e) =>
				69 + (12 * Math.log(e / t.Frequency.A4)) / Math.LN2),
			t.Frequency
		);
	})(h);
	var v;
			...
			(t.Context.prototype._defineProperty = function (t, e) {
				this.isUndef(this[e]) &&
					Object.defineProperty(this, e, {
						get: () => ("function" == typeof t[e] ? t[e].bind(t) : t[e]),
						set: (i) => {
							t[e] = i;
						},
					});
	...
	b = ((t) => (
		...
		(t.Param.prototype.setRampPoint = function (t) {
			...
			return (
				0 === e && (e = this._minOutput), this._param.setValueAtTime(e, t), this
			);
		}),
	...
	q = ((t) => (
		...
		(t.TimelineSignal.prototype._exponentialApproach = (t, e, i, n, o) =>
			i + (e - i) * Math.exp(-(o - t) / n)),
		(t.TimelineSignal.prototype._linearInterpolate = (t, e, i, n, o) =>
			e + (n - e) * ((o - t) / (i - t))),
	...
	M = (() => {
		...
		a.setContext(e.audiocontext),
			...
			(t.Envelope.prototype.checkExpInput = (t) => (0 >= t && (t = 1e-8), t)),
	...
	C = (() => {
		...
		(e.inputSources = []),
			...
			(t.AudioIn.prototype.start = function (t, i) {
				...
				var o = e.inputSources[this.currentSource],
					r = {
						audio: {
				...
				e.inputSources[this.currentSource] && (r.audio.deviceId = o.deviceId),
					window.navigator.mediaDevices
						...
						.then((i) => {
							(this.stream = i),
								(this.enabled = !0),
								(this.mediaStream = e.audiocontext.createMediaStreamSource(i)),
			...
			(t.AudioIn.prototype.getSources = (t, i) =>
				new Promise((n, o) => {
					window.navigator.mediaDevices
						.enumerateDevices()
						.then((i) => {
							(e.inputSources = i.filter((t) => "audioinput" === t.kind)),
								n(e.inputSources),
								t && t(e.inputSources);
						})
						["catch"]((t) => {
	...
	N = ((t) => (
		(t.GreaterThanZero = function () {
			(this._thresh = this.output =
				new t.WaveShaper((t) => (0 >= t ? 0 : 1), 127)),
	...
	G = ((t) => (
		...
		(t.Pow.prototype._expFunc = (t) => (e) => Math.pow(Math.abs(e), t)),
	...
	j = (function (t) {
		...
		function n(t) {
			return t ? Number.parseFloat(t) : void 0;
		}
		function o(t) {
			return t && t.args ? Number.parseFloat(t.args) : void 0;
		}
		return (
			(t.Expr = function () {
			...
			(t.Expr._Expressions = {
				value: {
					...
					input: { regexp: /^\$\d/, method: (t, e) => e.input[n(t.substr(1))] },
				},
				glue: {
					"(": { regexp: /^\(/ },
					")": { regexp: /^\)/ },
				...
				binary: {
					...
					"-": {
						...
						precedence: 1,
						method: (n, o) =>
							1 === n.length ? i(t.Negate, n, o) : e(t.Subtract, n, o),
					},
					"*": {
						regexp: /^\*/,
						precedence: 0,
			...
			(t.Expr.prototype._parseInputs = (t) => {
				var e = t.match(/\$\d/g),
					i = 0;
				if (null !== e)
					for (var n = 0; n < e.length; n++) {
						var o = Number.parseInt(e[n].substr(1)) + 1;
						i = Math.max(i, o);
					}
				return i;
			}),
			(t.Expr.prototype._replacements = (t) => {
				for (var e = t.shift(), i = 0; i < t.length; i++)
					e = e.replace(/\%/i, t[i]);
				return e;
			}),
			(t.Expr.prototype._tokenize = (e) => {
				function i(e) {
	...
	Q = (() => {
		...
		return (
			...
			(t.EQ.prototype._newBand = (t, e) => new i(t, e)),
			(t.EQ.prototype.dispose = function () {
				if ((e.prototype.dispose.apply(this), this.bands)) {
					while (this.bands.length > 0) delete this.bands.pop().dispose();
					delete this.bands;
				}
			}),
			t.EQ
					...
					(u.onload = () => {
						if (200 === u.status)
							a.decodeAudioData(
								...
								() => {
									var t = new e("decodeAudioData", s, this.url),
										i = "AudioContext error at decodeAudioData for " + this.url;
									o
										? ((t.msg = i), o(t))
										: console.error(
												i + "\n The error stack trace includes: \n" + t.stack,
							...
							var t = new e("loadConvolver", s, this.url),
								c =
									"Unable to load " +
									this.url +
									". The request status was: " +
			...
			(t.Score = function () {
				...
				for (var i in arguments)
					arguments[i] &&
						...
						(this.parts[i].onended = () => {
							this.resetPart(i), e(this);
						}));
				this.looping = !1;
			}),
			...
			(t.SoundLoop = function (t, n) {
				...
				this.clock = new i({
					callback: (t) => {
						...
						i > 0 && this.iterations <= this.maxIterations && this.callback(i);
					},
	...
	ct = (() => {
		...
		return (
			...
			(t.AudioVoice.prototype.play = (t, e, i, n) => {}),
			(t.AudioVoice.prototype.triggerAttack = (t, e, i) => {}),
			(t.AudioVoice.prototype.triggerRelease = (t) => {}),
			(t.AudioVoice.prototype.amp = (t, e) => {}),
