...
p5.prototype.collideDebug = (debugMode) => {
	_collideDebug = debugMode;
};

/*~++~+~+~++~+~++~++~+~+~ 2D ~+~+~++~+~++~+~+~+~+~+~+~+~+~+~+*/

p5.prototype.collideRectRect = (x, y, w, h, x2, y2, w2, h2) => {
	//2d
...
p5.prototype.collideRectRectVector = (p1, sz, p2, sz2) =>
	p5.prototype.collideRectRect(
		p1.x,
		p1.y,
		sz.x,
		sz.y,
...
p5.prototype.collideRectCircleVector = (r, sz, c, diameter) =>
	p5.prototype.collideRectCircle(r.x, r.y, sz.x, sz.y, c.x, c.y, diameter);
...
p5.prototype.collideCircleCircleVector = (p1, d, p2, d2) =>
	p5.prototype.collideCircleCircle(p1.x, p1.y, d, p2.x, p2.y, d2);
...
p5.prototype.collidePointCircleVector = (p, c, d) =>
	p5.prototype.collidePointCircle(p.x, p.y, c.x, c.y, d);
...
p5.prototype.collidePointEllipseVector = (p, c, d) =>
	p5.prototype.collidePointEllipse(p.x, p.y, c.x, c.y, d.x, d.y);

p5.prototype.collidePointRect = (pointX, pointY, x, y, xW, yW) => {
	//2d
	if (
...
p5.prototype.collidePointRectVector = (point, p1, sz) =>
	p5.prototype.collidePointRect(point.x, point.y, p1.x, p1.y, sz.x, sz.y);
...
p5.prototype.collidePointLineVector = (point, p1, p2, buffer) =>
	p5.prototype.collidePointLine(
		point.x,
		point.y,
		p1.x,
		p1.y,
...
p5.prototype.collideLineCircleVector = (p1, p2, c, diameter) =>
	p5.prototype.collideLineCircle(p1.x, p1.y, p2.x, p2.y, c.x, c.y, diameter);
...
p5.prototype.collideLineLineVector = (p1, p2, p3, p4, calcIntersection) =>
	p5.prototype.collideLineLine(
		p1.x,
		p1.y,
		p2.x,
		p2.y,
...
p5.prototype.collideLineRectVector = (p1, p2, r, rsz, calcIntersection) =>
	p5.prototype.collideLineRect(
		p1.x,
		p1.y,
		p2.x,
		p2.y,
...
p5.prototype.collidePointPoly = (px, py, vertices) => {
	var collision = false;
...
p5.prototype.collidePointPolyVector = (p1, vertices) =>
	p5.prototype.collidePointPoly(p1.x, p1.y, vertices);
...
p5.prototype.collideCirclePolyVector = (c, diameter, vertices, interior) =>
	p5.prototype.collideCirclePoly(c.x, c.y, diameter, vertices, interior);
...
p5.prototype.collideRectPolyVector = (r, rsz, vertices, interior) =>
	p5.prototype.collideRectPoly(r.x, r.y, rsz.x, rsz.y, vertices, interior);
...
p5.prototype.collideLinePolyVector = (p1, p2, vertice) =>
	p5.prototype.collideLinePoly(p1.x, p1.y, p2.x, p2.y, vertice);
...
p5.prototype.collidePolyPolyVector = (p1, p2, interior) =>
	p5.prototype.collidePolyPoly(p1, p2, interior);
...
p5.prototype.collidePointTriangleVector = (p, p1, p2, p3) =>
	p5.prototype.collidePointTriangle(
		p.x,
		p.y,
		p1.x,
		p1.y,
...
p5.prototype.collidePointPointVector = (p1, p2, buffer) =>
	p5.prototype.collidePointPoint(p1.x, p1.y, p2.x, p2.y, buffer);
...
p5.prototype.collidePointArcVector = (
	p1,
	a,
	arcRadius,
	arcHeading,
