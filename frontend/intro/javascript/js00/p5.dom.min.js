			...
			if ("INPUT" !== t.tagName || "checkbox" !== t.type)
				return "VIDEO" === t.tagName || "AUDIO" === t.tagName
					...
					: "SELECT" === t.tagName
						...
						: 0 < e.length &&
								e.every((t) => "INPUT" === t.tagName || "LABEL" === t.tagName)
	...
	["div", "p", "span"].forEach((i) => {
		...
		(d.Element.prototype.value = function () {
			return 0 < arguments.length
				...
				: "range" === this.elt.type
					? Number.parseFloat(this.elt.value)
					: this.elt.value;
		}),
		...
		(d.MediaElement = function (n, t) {
			...
			(this.elt.crossOrigin = "anonymous"),
				...
				Object.defineProperty(this, "src", {
					get: () => {
						var t = this.elt.children[0].src,
							e = this.elt.src === window.location.href ? "" : this.elt.src;
						return t === window.location.href ? e : t;
					},
					set: (t) => {
						for (var e = 0; e < this.elt.children.length; e++)
							this.elt.removeChild(this.elt.children[e]);
